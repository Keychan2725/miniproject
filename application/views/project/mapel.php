                    ...
                    <div class="col-12 card p-2">
                        ...
                        <div class="card-body min-vh-100  align-items-center">
                            <div class="card w-100 m-auto p-5">
                                ...
                                <div class=" d-flex ">
                                    <p class="class fs-4">Data Mapel</p>
                                ...
                                <table class="table  table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">
                                                <a href="<?php echo base_url('project/update_mapel/') . $row->id ?>"
                                ...
                                <a href="<?php echo base_url('project/tambah_mapel') ?>"
                                    ...
                                    if (result.isConfirmed) {
                                        Swal.fire({
                                            ...
                                            window.location.href =
                                                "<?php echo base_url('Project/hapus_mapel/')?>" + id;
                                        });
                                    }
                                });
                            }
